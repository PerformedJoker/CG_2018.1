...
canvas.addEventListener('click', function(evt)
{
	...
	//alert("O valor do ponto clicado é :" + pontoClicado.x+","+ pontoClicado.y)
})
...
canvas.addEventListener('mousemove', function(evt)
{
	...
	// console.log("o valor de pos.x é: "+ pos.x);
	// console.log("o valor de pos.y é: "+ pos.y);
	//var ponto_medio = calcPontoMed(pos);
	...
	if(scale == 2 && pick != null)
	{
		...
		context.lineTo(pos.x,pontoClicado.y);//para o tracejado ficar somente na horizontal
		...
		pick.drawScale(rate,pontoClicado);
...
canvas.addEventListener('mousedown', function(evt)
{
	...
	else if(scale == 2 && pick != null)
	{
		...
		pick.scale(rate,pontoClicado);
		//alert("hueueuheuhe"+getEndPos());
		//console.log(pick);
	}
